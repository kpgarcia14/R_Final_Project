...
We made further analyses in the most diverse locality we sampled, the SFFC. The TDF in SFFC is currently under threat, so as a conservation measure, local authorities had started a recovery area with a buffer zone adjacent to the forest fragment. As Cerambycidae species are known to be conservation indicators (Hjältén *et al*. 2012), we compared the abundance, richness and biomass between forest and buffer habitats. 
...
Lastly, given the differences in the natural history between the subfamilies of Cerambycidae, we analyzed their abundance in each habitat. We found Lamiinae to be more abundant in the buffer zone, suggesting a generalist behavior, able to adapt to all types of resources, and not depend on only the ones offered in the forest. Further studies on the habitat specialization of the species that compose Lamiinae subfamily are highly recommended to confirm this hypothesis. 
